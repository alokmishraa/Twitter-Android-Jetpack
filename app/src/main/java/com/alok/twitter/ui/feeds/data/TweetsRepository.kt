package com.alok.twitter.ui.feeds.data
    ...
    private fun prepareTweets() {
        ...
        tweetsList.add(
            Tweet(
                ...
                tUText = "As checked the refund of JPY 3000 is under process it will reflect to the mode of payment in 5-7 working days so, request you to please wait for the same as it is already escalated to the team to process the refund on priority. Your patience is highly appreciated.\n",
                tUTime = 1622360101468L,
        ...
        tweetsList.add(
            Tweet(
                ...
                tUText = "Celebrate the diversity of Asian American and Pacific Islander communities with this collection of podcasts about identity, history, culture, food and more. https://apple.co/NeverVoiceless #APAHM\n",
